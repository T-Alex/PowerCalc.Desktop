...
namespace Microsoft.Windows.Controls
{
    ...
    public struct DataGridLength : IEquatable<DataGridLength>
    {
        ...
        public DataGridLength(double value, DataGridLengthUnitType type, double desiredValue, double displayValue)
        {
            ...
            {
                throw new ArgumentException("Value should not be infinity.", "value");
            }
            ...
            {
                throw new ArgumentException("Value should not be infinity.", "desiredValue");
            }

            if (Double.IsInfinity(displayValue))
            {
                throw new ArgumentException("Value should not be infinity.", "displayValue");
            }
