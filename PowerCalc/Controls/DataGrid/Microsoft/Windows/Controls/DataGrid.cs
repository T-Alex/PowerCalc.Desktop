...
namespace Microsoft.Windows.Controls
{
    ...
    public class DataGrid : MultiSelector
    {
        ...
        /// </summary>
        public static readonly RoutedCommand BeginEditCommand = new RoutedCommand("Begin Edit", typeof(DataGrid));

        /// <summary>
        /// The command to fire and allow to route to the DataGrid in order to indicate that the
        /// current cell or row should commit any pending changes and exit edit mode.
        /// </summary>
        public static readonly RoutedCommand CommitEditCommand = new RoutedCommand("Commit Edit", typeof(DataGrid));
        ...
        /// in before BeginEdit.
        /// </summary>
        public static readonly RoutedCommand CancelEditCommand = new RoutedCommand("Cancel Edit", typeof(DataGrid));

        /// <summary>
        /// A command that, when invoked, will delete the current row.
        /// </summary>
        public static readonly RoutedCommand DeleteCommand = new RoutedCommand("Delete", typeof(DataGrid));

        /// <summary>
        /// A command that, when invoked, will select all items in the DataGrid.
        /// </summary>
        public static readonly RoutedCommand SelectAllCommand = new RoutedCommand("Select All", typeof(DataGrid));
        ...
        static DataGrid()
        {
            ...
            CommandManager.RegisterClassInputBinding(ownerType, new InputBinding(SelectAllCommand, DataGridHelper.CreateFromResourceStrings("Ctrl+A", "Ctrl+A")));
        ...
        protected override void PrepareContainerForItemOverride(DependencyObject element, object item)
        {
            ...
            row.Header = (Items.IndexOf(item) + 1).ToString(); // !!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        {
            bool canExecute = !IsReadOnly && (CurrentCellContainer != null) && !IsEditingCurrentCell && !IsCurrentCellReadOnly;
        ...
        internal void OnSelectedCellsChanged(NotifyCollectionChangedAction action, VirtualizedCellInfoCollection oldItems, VirtualizedCellInfoCollection newItems)
        {
            ...
            {
                throw new InvalidOperationException("Cannot change cell selection when the SelectionUnit is FullRow.");
            }
        ...
        internal void OnEnterKeyDown(KeyEventArgs e)
        {
            DataGridCell currentCellContainer = CurrentCellContainer;
